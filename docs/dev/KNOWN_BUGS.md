Scratch inbox for bug reports. Not agent-ready as-is — see
`docs/AGENT_WORKFLOW.md`. When you're ready to fix one, promote it to a task
file in `docs/tasks/` (copy `docs/tasks/TEMPLATE.md`) and delete the line here.
